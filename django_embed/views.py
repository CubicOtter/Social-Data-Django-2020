...
def homepage(request: HttpRequest) -> HttpResponse:
    ...
    script5 = server_document(request._current_scheme_host + "/bokeh_apps/lines_energy_consumption")
    script6 = server_document(request._current_scheme_host + "/bokeh_apps/lines_air_traffic")
    script7 = server_document(request._current_scheme_host + "/bokeh_apps/lines_corona")
    script8 = server_document(request._current_scheme_host + "/bokeh_apps/lines_air_quality")
    return render(request, 'index.html', dict(script1=script1,script2=script2,script3=script3,script4=script4,script5=script5,script6=script6,script7=script7,script8=script8))
